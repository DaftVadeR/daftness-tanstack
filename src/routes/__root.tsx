  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" type="image/png" href="/favicon-96x96.png?new=1" sizes="96x96" />
        <link rel="icon" type="image/svg+xml" href="/favicon.svg?new=1" />
        <link rel="shortcut icon" href="/favicon.ico?new=1" />
        <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png?new=1" />
