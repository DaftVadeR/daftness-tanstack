...
export const showMatrixBtnStyle = twMerge(`
   bg-white rounded-full px-6 py-3 text-md md:text-lg hover:bg-gray-200 transition text-black hover:text-purple-800 cursor-pointer hover:scale-105 scale:100 transition-all duration-500 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-2 absolute
`);
