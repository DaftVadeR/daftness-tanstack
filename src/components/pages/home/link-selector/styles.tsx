...
export const listStyle = twMerge(`
   ...
   before:absolute before:left-0 before:bottom-3 before:z-3 before:pointer-events-none inline-flex mt-30 mb-12 relative bg-white
...
export const linkStyle = twMerge(`mx-4 text-xl md:text-2xl hover:text-purple-700 text-black transition-all duration-500 relative z-2`);
